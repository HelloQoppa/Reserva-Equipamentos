package br.ucsal.bes20182.testequalidade.config;
...
import br.ucsal.bes20182.testequalidade.googlechrome.GoogleChromeTest;
...
public class Test extends JUnitStories {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new GoogleChromeTest());
	}
